      ...
      <div className="flex flex-col gap-y-7 xl:ml-5 w-full max-xl:px-5">
        ...
        <div className="mt-5">
          <label className="w-full">
            <div>
              <span className="text-xl font-bold">ID đơn hàng:</span>
        ...
        <div className="flex gap-x-2 max-sm:flex-col">
          ...
          <div>
            <label className="form-control w-full max-w-xs">
              <div className="label">
                <span className="label-text">Căn hộ, số nhà:</span>
              </div>
              <input
                type="text"
                className="input input-bordered w-full max-w-xs"
        ...
        <div>
          <label className="form-control">
            <div className="label">
              <span className="label-text">Chú thích đơn hàng:</span>
            </div>
            <textarea
          ...
          {orderProducts?.map((product) => (
            <div className="flex items-center gap-x-4" key={product?.id}>
              ...
              <div>
                ...
                <p>
                  ${product?.product?.price} * {product?.quantity} sản phẩm
                </p>
              </div>
            </div>
          ))}
          <div className="flex flex-col gap-y-2 mt-10">
            <p className="text-2xl">Tổng giá trị sản phẩm: ${order?.total}</p>
            <p className="text-2xl">Thuế 20%: ${order?.total / 5}</p>
            <p className="text-2xl">Phí ship: $5</p>
            <p className="text-3xl font-semibold">
              Tổng cộng: ${order?.total + order?.total / 5 + 5}
            </p>
          </div>
